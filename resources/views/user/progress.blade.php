...
<div class="progress-page">
    <div class="portal-shell">
        ...
        <div class="portal-stage">
            ...
            @if ($classes->isEmpty())
                <div class="progress-empty-note">
                    学年データがまだ未登録のため、下のカードはレイアウトサンプルです。授業データを登録するとこのエリアに一覧表示されます。
                </div>
                                ...
                                <ul class="progress-card__list">
                                    @foreach ($class->curriculums as $curriculum)
                                        ...
                                        <li class="progress-card__item">
                                            ...
                                            <span class="progress-card__status {{ $isCompleted ? 'is-complete' : 'is-pending' }}">
                                                {{ $isCompleted ? '受講済み' : '未受講' }}
                                            </span>
                                        </li>
                                    @endforeach
                                </ul>
